...
func (tc *BrowseTestCase) Name(testName string) *BrowseTestCase {
...
// Browse executes the web handler and returns a corresponding test case.
func Browse(t *testing.T, ctx context.Context, options ...WebOption) *BrowseTestCase {
	tc := &BrowseTestCase{t: t}
	pubOptions := []pub.Option{
		pub.URL(httpx.JoinHostAndPath("browser.example", `:443/browse`)),
	}
