...
var (
	...
	// Svc is the helloworld.example microservice being tested
	Svc *Service
)
...
// HelloWorldTestCase assists in asserting against the results of executing HelloWorld.
...
func (tc *HelloWorldTestCase) StatusOK() *HelloWorldTestCase {
...
func (tc *HelloWorldTestCase) StatusCode(statusCode int) *HelloWorldTestCase {
	if testarossa.NoError(tc.t, tc.err) {
...
func (tc *HelloWorldTestCase) BodyContains(value any) *HelloWorldTestCase {
	if testarossa.NoError(tc.t, tc.err) {
		var body []byte
...
func (tc *HelloWorldTestCase) BodyNotContains(value any) *HelloWorldTestCase {
	if testarossa.NoError(tc.t, tc.err) {
		var body []byte
		if br, ok := tc.res.Body.(*httpx.BodyReader); ok {
			body = br.Bytes()
...
func (tc *HelloWorldTestCase) HeaderContains(headerName string, value string) *HelloWorldTestCase {
	if testarossa.NoError(tc.t, tc.err) {
...
func (tc *HelloWorldTestCase) HeaderNotContains(headerName string, value string) *HelloWorldTestCase {
	if testarossa.NoError(tc.t, tc.err) {
...
func (tc *HelloWorldTestCase) HeaderEqual(headerName string, value string) *HelloWorldTestCase {
	if testarossa.NoError(tc.t, tc.err) {
...
func (tc *HelloWorldTestCase) HeaderNotEqual(headerName string, value string) *HelloWorldTestCase {
	if testarossa.NoError(tc.t, tc.err) {
...
func (tc *HelloWorldTestCase) HeaderExists(headerName string) *HelloWorldTestCase {
	if testarossa.NoError(tc.t, tc.err) {
...
func (tc *HelloWorldTestCase) HeaderNotExists(headerName string) *HelloWorldTestCase {
	if testarossa.NoError(tc.t, tc.err) {
...
func (tc *HelloWorldTestCase) ContentType(expected string) *HelloWorldTestCase {
	if testarossa.NoError(tc.t, tc.err) {
...
*/
func (tc *HelloWorldTestCase) TagExists(cssSelectorQuery string) *HelloWorldTestCase {
	if testarossa.NoError(tc.t, tc.err) {
...
*/
func (tc *HelloWorldTestCase) TagNotExists(cssSelectorQuery string) *HelloWorldTestCase {
	if testarossa.NoError(tc.t, tc.err) {
		selector, err := cascadia.Compile(cssSelectorQuery)
		if !testarossa.NoError(tc.t, err, "Invalid selector %s", cssSelectorQuery) {
			return tc
...
*/
func (tc *HelloWorldTestCase) TagEqual(cssSelectorQuery string, value string) *HelloWorldTestCase {
...
*/
func (tc *HelloWorldTestCase) TagContains(cssSelectorQuery string, value string) *HelloWorldTestCase {
	var textMatches func(n *html.Node) bool
	textMatches = func(n *html.Node) bool {
		for x := n.FirstChild; x != nil; x = x.NextSibling {
...
*/
func (tc *HelloWorldTestCase) TagNotEqual(cssSelectorQuery string, value string) *HelloWorldTestCase {
	var textMatches func(n *html.Node) bool
	textMatches = func(n *html.Node) bool {
		for x := n.FirstChild; x != nil; x = x.NextSibling {
			if x.Data == value || textMatches(x) {
...
*/
func (tc *HelloWorldTestCase) TagNotContains(cssSelectorQuery string, value string) *HelloWorldTestCase {
	var textMatches func(n *html.Node) bool
	textMatches = func(n *html.Node) bool {
		for x := n.FirstChild; x != nil; x = x.NextSibling {
			if strings.Contains(x.Data, value) || textMatches(x) {
...
func (tc *HelloWorldTestCase) Error(errContains string) *HelloWorldTestCase {
...
func (tc *HelloWorldTestCase) ErrorCode(statusCode int) *HelloWorldTestCase {
	if testarossa.Error(tc.t, tc.err) {
...
func (tc *HelloWorldTestCase) NoError() *HelloWorldTestCase {
	testarossa.NoError(tc.t, tc.err)
	return tc
}

// CompletedIn checks that the duration of the operation is less than or equal the threshold.
func (tc *HelloWorldTestCase) CompletedIn(threshold time.Duration) *HelloWorldTestCase {
	testarossa.True(tc.t, tc.dur <= threshold)
	return tc
}

// Assert asserts using a provided function.
func (tc *HelloWorldTestCase) Assert(asserter func(t *testing.T, res *http.Response, err error)) *HelloWorldTestCase {
	asserter(tc.t, tc.res, tc.err)
	return tc
}

// Get returns the result of executing HelloWorld.
func (tc *HelloWorldTestCase) Get() (res *http.Response, err error) {
...
*/
func HelloWorld_Get(t *testing.T, ctx context.Context, url string) *HelloWorldTestCase {
	tc := &HelloWorldTestCase{t: t}
	var err error
	url, err = httpx.ResolveURL(helloworldapi.URLOfHelloWorld, url)
	if err != nil {
...
*/
func HelloWorld_Post(t *testing.T, ctx context.Context, url string, contentType string, body any) *HelloWorldTestCase {
	tc := &HelloWorldTestCase{t: t}
	var err error
	url, err = httpx.ResolveURL(helloworldapi.URLOfHelloWorld, url)
	if err != nil {
...
*/
func HelloWorld(t *testing.T, r *http.Request) *HelloWorldTestCase {
	tc := &HelloWorldTestCase{t: t}
	var err error
	if r == nil {
	...
	url, err := httpx.ResolveURL(helloworldapi.URLOfHelloWorld, r.URL.String())
	if err != nil {
		tc.err = errors.Trace(err)
		return tc
	}
