...
/*
Package smtpingressapi implements the public API of the smtp.ingress.sys microservice,
...
// Hostname is the default hostname of the microservice: smtp.ingress.sys.
const Hostname = "smtp.ingress.sys"

// Fully-qualified URLs of the microservice's endpoints.
var (
)

// Client is an interface to calling the endpoints of the smtp.ingress.sys microservice.
...
// NewClient creates a new unicast client to the smtp.ingress.sys microservice.
func NewClient(caller service.Publisher) *Client {
	return &Client{
		svc:  caller,
		host: "smtp.ingress.sys",
	}
}
...
// MulticastClient is an interface to calling the endpoints of the smtp.ingress.sys microservice.
...
// NewMulticastClient creates a new multicast client to the smtp.ingress.sys microservice.
...
// MulticastTrigger is an interface to trigger the events of the smtp.ingress.sys microservice.
type MulticastTrigger struct {
	svc  service.Publisher
	host string
}

// NewMulticastTrigger creates a new multicast trigger of the smtp.ingress.sys microservice.
...
// Hook assists in the subscription to the events of the smtp.ingress.sys microservice.
type Hook struct {
	svc  service.Subscriber
	host string
}

// NewHook creates a new hook to the events of the smtp.ingress.sys microservice.
