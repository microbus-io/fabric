...
const (
	...
	Version     = litellmapi.Version
	Description = litellmapi.Description
)
...
func NewIntermediate(impl ToDo) *Intermediate {
	...
	svc.DefineConfig( // MARKER: ModelsURL
		"ModelsURL",
		cfg.Description(`ModelsURL is the URL of the LiteLLM proxy models-list endpoint, whose model_name entries are this provider's aliases.`),
		cfg.DefaultValue(`http://localhost:4000/v1/models`),
		cfg.Validation(`url`),
	)
