...
// Client provides type-safe access to the endpoints of the http.ingress.sys microservice.
...
// MulticastClient provides type-safe access to the endpoints of the http.ingress.sys microservice.
